...
class DTAASData(object):
    """DTAAS data.

    Generate scannet infos for dtaas_converter.
    ...
    def get_label_objects(self, idx):
        ...
        objects = [DTAASInstance(line) for line in lines]
        return objects
